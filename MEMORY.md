...
| پوشهٔ تنظیمات کاربر | **`config/` در ریشهٔ ریپو** — نمونه‌ها (`.example`) در گیت، فایل‌های واقعی (`.env`) هرگز؛ کاربر در فاز آخر خودش پر می‌کند و تغییر می‌دهد (user: «یک پوشه جدا باشه برای api سرورها... من تغییر بدم») | 2026-08-09 |
...
| 2026-08-11 | لاگ واقعی CI علت build APK را روشن کرد: Flutter، Gradle 8.7 و AGP 8.3.2 را پایین‌تر از حداقل‌های خود دانست. راه‌حل در کد: Gradle wrapper به 8.14 و AGP به 8.13.0 ارتقا یافت؛ Java 17 حفظ شد. | در انتظار CI |
